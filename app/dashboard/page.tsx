...
export default async function DashboardPage() {
	...
	// Fallback to avoid empty user crashes if NextAuth rejects a payload
		...
		if (!op.approved) {
			return (
				<AppShell title="Dashboard" subtitle="Pending approval">
					<div
						className="ticket-stub rounded-none border-2 border-foreground p-8 text-center neo-shadow"
