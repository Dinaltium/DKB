...
export default function AuthPage() {
	...
	return (
		<div className="buslink-page flex min-h-screen flex-col items-center justify-center px-4 py-12">
			{/* ── Card ── */}
			<div
			...
			>
				...
				<div className="space-y-3">
					...
					<div className="relative">
						<input
							...
							className="theme-input brutal-transition brutal-focus h-12 w-full rounded-none border-2 border-foreground px-3 pr-11 text-sm outline-none neo-shadow"
							style={inputStyle}
							autoComplete={
				...
				<div
					className="mt-6 rounded-none border-2 border-foreground px-3 py-2 text-xs font-medium normal-case tracking-normal neo-shadow"
					style={{
						background: "var(--bg-surface-2)",
						borderColor: "var(--border-default)",
				...
				>
					Operators and admins — sign in with your registered email. Your
					dashboard appears automatically based on your account role.
				</div>
			</div>
		</div>
	);
