	...
	return (
		<>
			...
			<section className="grid gap-4 md:grid-cols-2">
				<div
					className="ticket-stub rounded-none border-2 p-5 shadow-[4px_4px_0_hsl(var(--foreground))]"
					style={cardStyle}
				>
					<p
					...
					<div className="mt-3 space-y-3 text-sm">
						...
						<p className="text-sm" style={{ color: "var(--text-secondary)" }}>
							...
							{bus.studentCardAccepted ? (
								<span className="font-bold uppercase tracking-wide text-[#0E7C86]">
			...
			<section className="mt-6 grid gap-4 md:grid-cols-[220px_1fr]">
				<div
					className="flex flex-col items-center rounded-none border-2 p-4 shadow-[4px_4px_0_hsl(var(--foreground))]"
					style={cardStyle}
				>
					<QrCode
				...
				>
					...
					>
						...
						<p>
							Full Route Fare:{" "}
							<strong className="text-[#0E7C86]">₹{bus.fullFare}</strong>
						</p>
						<p>
						...
						{!session && (
							...
							>
								<a
									href="/auth"
									className="font-bold uppercase tracking-wide text-[#0E7C86] hover:underline"
								>
									Sign in
								</a>{" "}
