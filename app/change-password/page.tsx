		...
		>
			<div className="mx-auto w-full max-w-lg flex-1">
				...
				<div className="mt-6 space-y-4">
					<div className="relative">
						<input
							...
							className="h-12 w-full rounded-none border-2 border-foreground bg-background px-3 pr-11 text-sm outline-none neo-shadow focus-visible:translate-x-[4px] focus-visible:translate-y-[4px] focus-visible:neo-shadow-none"
							style={{
				...
				<button
					...
					disabled={isPending}
					className="mt-6 h-12 w-full rounded-none border-2 text-sm font-bold uppercase tracking-widest neo-shadow transition-all hover:translate-x-[4px] hover:translate-y-[4px] hover:neo-shadow-none disabled:opacity-60"
					style={{
