    ...
    >
      <div className="mx-auto w-full max-w-lg flex-1">
        ...
        <p
          ...
          style={{
            color: expired ? "var(--status-stopped-text)" : "var(--text-secondary)",
          }}
        >
          {expiresAt ? (
            expired ? (
              <span style={{ color: "var(--status-stopped-text)" }}>EXPIRED</span>
            ) : (
              <>{timeLabel}</>
            )
          ) : (
        ...
        <div className="mt-6 space-y-4">
          ...
          {newPassword.length > 0 && newPassword.length < 8 && (
            <p className="text-xs" style={{ color: "var(--status-stopped-text)" }}>
