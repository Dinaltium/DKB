					...
					<div className="flex items-center gap-6">
						<div className="relative">
							...
							<button
								...
								className="absolute -bottom-1 -right-1 flex h-8 w-8 items-center justify-center border-2 border-foreground bg-primary text-primary-foreground neo-shadow brutal-transition brutal-hover"
							>
			...
			<CardContent className="space-y-6">
				...
				<div className="space-y-4">
					{settings.map((setting) => (
						<div
							key={setting.id}
							className="flex items-center justify-between border-3 border-foreground bg-card p-4 neo-shadow"
						>
							<div>
...
export function SecuritySettings({
	...
	return (
		<Card className={className}>
			...
			<CardContent className="space-y-6">
				{/* Password */}
				<div className="flex items-center justify-between border-3 border-foreground bg-muted/30 p-4 neo-shadow">
					<div className="flex items-center gap-4">
						<div className="flex h-10 w-10 items-center justify-center border-2 border-foreground bg-card neo-shadow">
						...
						<div>
							...
							<div className="space-y-3">
								{sessions.map((session) => (
									<div
										key={session.id}
										className="flex items-center justify-between border-2 border-foreground p-3 neo-shadow"
									>
										<div>
					...
					<div className="grid grid-cols-3 gap-3">
						{[
							...
							<button
								...
								className={cn(
									"brutal-transition brutal-hover flex flex-col items-center gap-2 border-3 border-foreground p-4 neo-shadow",
									theme === value
					...
					<div className="flex flex-wrap gap-3">
						{accentColors.map((color) => (
							<button
								...
								className={cn(
									"brutal-transition brutal-hover h-10 w-10 border-3 border-foreground neo-shadow",
	...
	return (
		<Card className={cn("border-destructive", className)}>
			...
			<CardContent className="space-y-4">
				<div className="flex items-center justify-between border-2 border-foreground p-4 neo-shadow">
					<div>
				...
				<div className="flex items-center justify-between border-2 border-destructive/50 bg-destructive/5 p-4 neo-shadow">
					<div>
