				...
				>
					...
					<div className="flex gap-1">
						...
						<button
							...
							className="flex h-7 w-7 items-center justify-center rounded-none border-2 text-xs font-bold neo-shadow transition-all hover:translate-x-[4px] hover:translate-y-[4px] hover:neo-shadow-none"
							style={{
