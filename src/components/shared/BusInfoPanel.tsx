		...
		<div className="flex flex-col gap-0">
			...
			<div className="flex gap-2 mb-4">
				<button
					...
					className={`${TAB_BASE} ${
						activeTab === "info"
							? "theme-btn-dark translate-x-[4px] translate-y-[4px] shadow-none"
							: "theme-btn-secondary"
					}`}
			...
			{activeTab === "info" && (
				<ScrollArea className="max-h-[520px]">
					<div className="pr-2 space-y-0">
						...
						>
							<div
								className="theme-bg-navy flex h-16 w-16 shrink-0 items-center justify-center border-2 border-foreground font-black text-xl text-white neo-shadow"
								style={{
									fontFamily: "'Barlow Condensed', sans-serif",
								}}
							>
								<Bus className="theme-text-amber h-7 w-7" />
							</div>
							<div>
								<p
							...
							{(
								[
									[
										...
										<Star key="rating" className="theme-text-amber h-3 w-3" />,
									],
									[
										"Complaints",
										...
										<AlertTriangle
											key="complaints"
											className="theme-text-danger h-3 w-3"
										/>,
									],
									[
										"Fines",
									...
									[
										...
										<DollarSign
											key="revenue"
											className="theme-text-teal h-3 w-3"
										/>,
									],
									[
										"Pending",
										...
										<AlertTriangle
											key="pending"
											className="theme-text-amber h-3 w-3"
										/>,
									],
									[
										"Seats",
										`${bus.totalSeats - bus.occupiedSeats}/${bus.totalSeats}`,
										<User key="seats" className="theme-text-teal h-3 w-3" />,
									],
						...
						>
							...
							<div className="grid grid-cols-3 gap-2">
								{[
									["On Time", bus.votes.onTime, "var(--color-teal)"],
									[
										"Slightly Late",
										bus.votes.slightlyLate,
										"var(--color-amber)",
									],
									["Very Late", bus.votes.veryLate, "hsl(var(--destructive))"],
						...
						>
							<div className="flex items-center gap-1.5 mb-3">
								<Route className="theme-text-teal h-3.5 w-3.5" />
										...
										{routeStops.map((stop, idx) => {
											...
											return (
												...
												>
													...
													>
														{(isFirst || isLast) && (
															<div className="theme-bg-amber h-1.5 w-1.5 rounded-full" />
														)}
													</div>
					...
					<div className="pr-2 space-y-3">
						...
						<div>
							...
							<select
								...
								className="theme-input brutal-transition brutal-focus mt-1 h-10 w-full rounded-none border-2 border-foreground px-2 text-sm neo-shadow"
								style={{
						...
						<Button
							...
							className="w-full rounded-none border-2 border-foreground font-bold uppercase neo-shadow"
						>
