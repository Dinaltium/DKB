...
export function ImportStopsModal({
  ...
  return (
    <ModalFrame title="Import stops preview" onClose={onClose}>
      <p className="text-xs text-muted-foreground">{data.length} stops found in file</p>
      <ScrollArea className="mt-2 max-h-72 rounded-none border-2 border-foreground">
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b-2 border-foreground">
              <th className="p-2 text-left font-black uppercase tracking-widest">#</th>
              <th className="p-2 text-left font-black uppercase tracking-widest">ID</th>
              <th className="p-2 text-left font-black uppercase tracking-widest">Name</th>
              <th className="p-2 text-left font-black uppercase tracking-widest">Lat</th>
              <th className="p-2 text-left font-black uppercase tracking-widest">Lng</th>
            </tr>
          </thead>
          <tbody>
            {data.map((s, i) => (
